...
> 经过多天的实践，踩了多个大坑，确实可行的方案
> 不要过度相信网上各种推广文章，使用诸如ExpressVPN之类的海外知名VPN
> 这类厂商都十分容易被针对，这是非常深刻的教训，不过过多浪费自己的时间
> 目前比较流行使用机场节点翻墙,经过实践，稳定可靠
> 不论是官改的固件，还是梅林的固件，目前都已经十分成熟了
...
![状态监控界面](images/status-monitoring.png)
